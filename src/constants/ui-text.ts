export const UI_TEXT = {
  ...
  identify: {
    ...
    // Phase 15 S4: 大菌輪統制形質ベースの簡易識別 (v2)
    simpleIntro: '観察できる特徴にチェックを入れてください。選択が多いほど絞り込めます。',
    simpleSelectedLabel: '選択中',
    simpleClearAll: 'すべてクリア',
    simpleNoSelection: 'まだ特徴が選ばれていません',
    simpleNoResults: '条件に一致するキノコが見つかりませんでした。選択を見直してみてください。',
    simpleResultsHeading: '候補',
    simpleMatchRate: '一致率',
    simpleMatchCount: '一致',
    simpleDangerLabel: '毒キノコ含む',
    simpleDangerWarning: '候補に有毒種が含まれています。採取前に必ず図鑑で個別の詳細を確認してください。',
    simpleMonthHeading: '観察した月',
    simpleMonthAny: '指定なし',
    simpleMonthHint: '発生期で絞り込み',
    simpleMonthMatched: '旬',
    simpleScoreLabel: '一致度',
    simpleAttribution: '形質データ: 大菌輪 Trait Circus Database (CC BY 4.0)',
    referencePhoto: '参考写真',
  ...
  settings: {
    ...
    // Phase 13-F / 14: お知らせ
    noticeSection: 'お知らせ',
    noticeV22Title: 'v2.2 — 収録種を 113 → 385 に大幅拡充',
    noticeV22Body: '2026 年 4 月、大菌輪 (CC BY 4.0) を和名正典として新マスタを再構築。Wikipedia JA 記事のある種 385 種を収録しました（旧 113 種の記事・写真も維持）。ヒーロー画像は 9 割で Wikipedia JA メイン画像を採用。出典番号 [1][2] をタップすると該当ソースへ移動。色名下線のカバレッジを 212 色に拡張（紅・藍・栗・肌などの伝統色系を網羅）。',
  ...
  // Phase 13-F / 14 / 17: 起動時バナー (v2.2)
  banner: {
    v2Title: '収録種を大幅拡充しました (v2.2)',
    v2Body: '2026 年 4 月、大菌輪を和名正典とした新マスタで 113 → 385 種に拡充。Wikipedia JA メイン画像を優先採用、出典番号クリックで該当ソースへ移動できます。詳細は設定 > お知らせをご覧ください。',
    dismiss: '閉じる',
  },
  common: {
